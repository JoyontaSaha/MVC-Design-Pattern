...
/*
UserDao is a DAO layer (i.e. Database Access Object layer).
It contains various methods for storing and retrieving objects from a database.
services work with the DAO layer. No other classes touch the DAO. The business logic is described in services.
