...
/*
This class will receive requests from the client and notify the Model.
The Model, in turn, will update the DataModel.
 */
public class Controller {
    ...
    //method that accesses the model and triggers the loading the users
